...
BOT_TOKEN = getenv("BOT_TOKEN", "7982080430:AAHoDDq6NsQixXuHt_ttDWWZ1afiEMq4zGE")
...
LOG_GROUP = getenv("LOG_GROUP", "-1003076448923")
CHANNEL_ID = int(getenv("CHANNEL_ID", "-1003076448923"))
