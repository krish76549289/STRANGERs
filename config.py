...
BOT_TOKEN = getenv("BOT_TOKEN", "8506902979:AAHnsk1vuEQMTMtd51assh30bBjg3g7keKc")
OWNER_ID = list(map(int, getenv("OWNER_ID", "8303329083").split()))
...
LOG_GROUP = getenv("LOG_GROUP", "-1003986069892")
CHANNEL_ID = int(getenv("CHANNEL_ID", "-1003986069892"))
